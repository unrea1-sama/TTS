...
class HParams:
    def __init__(self):
        ...
        self.training_files='../biaobei/biaobei_pingyin-train.json'
        self.validation_files='../biaobei/biaobei_pingyin-dev.json'
        self.dict="../biaobei/biaobei_pingyin-dict.json"
